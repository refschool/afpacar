...
require_once "consult_profile_service.php";

/**
 * Class "Consult_profile" / file "consult_profile.php"
 *
 ...
 * @subpackage Consult_profile
 * @author @AfpaLabTeam - You
 * @copyright  1920-2080 Afpa Lab Team - DWWM
 * @version v1.0
 */
Class Consult_profile {
	 ...
	 * Constructor :
	 * 
	 * it is executed thanks to code "new Consult_profile()"
	...
	private function main() {
		...
		$this->oService= new Consult_profile_service();
