...
/**
 * Class "App_style_service" / file "app_style_service.php"
 *
 ...
 * @subpackage app_style_service
 * @author @AfpaLabTeam - You
 * @copyright  1920-2080 Afpa Lab Team - DWWM
 * @version v1.0
 */
Class App_style_service extends Initialize
{

  /**
   * Constructor :
   * 
   * it is executed thanks to code "new App_style_service()"
