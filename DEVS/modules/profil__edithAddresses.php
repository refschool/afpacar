...
Class Profile__editAddress {
	...
	private function main() {
        ...
        // I pass my parameters to have access to them in my HTML pages(qui est dans iniatlize.php)
        $this->VARS_HTML = $this->oService->VARS_HTML;
        // recuperer le resultat fonction dans la couche service qui va faire appel a ma bdd
        $this->oService->editAddress();
		// on va copier le tableau de resultat de la couche service vers la couche métier
