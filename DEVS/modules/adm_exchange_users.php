...
require_once "adm_exchange_users_service.php";

/**
 * Class "Adm_exchange_users" / file "adm_exchange_users.php"
 *
 ...
 * @subpackage Adm_exchange_users
 * @author @AfpaLabTeam - You
 * @copyright  1920-2080 Afpa Lab Team - DWWM
 * @version v1.0
 */
Class Adm_exchange_users {
	 ...
	 * Constructor :
	 * 
	 * it is executed thanks to code "new Adm_exchange_users()"
	...
	private function main() {
		...
		$this->oService= new Adm_exchange_users_service();
