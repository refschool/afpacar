 ...
 * @version v1.0
 */
Class Adm_gestionadmin__update_eta {
	 ...
	 * Constructor :
	 * 
	 * it is executed thanks to code "new Adm_gestionadmin()"
	...
	private function main() {
		...
		//execut methode update_eta in to object service and pass the parametres
		$this->oService->update_eta();
