...
* @version v1.0
*/
class Test_getSelectDatas_FAQ extends TestCase
{
/**
*
...
/** @test */
    public function should_contain_all_FAQ()
    {
        ...
        $spathSQL = $oInit->GLOBALS_INI["PATH_HOME"] . $oInit->GLOBALS_INI["PATH_MODEL"] . 'adm_faq__getfaq.sql';
        $aResofFAQ = $oInit->oBdd->getSelectDatas($spathSQL, array(), false);

        // --------- PART 4 ---------
        // Compare the 2 results with the assertion "assertCount" (Param 1 : number of results, Param 2  array of results)
        $this->assertCount($iNbFAQ, $aResofFAQ);
    }
}
