...
* @version v1.0
*/
class Test_getSelectDatas_infos extends TestCase
{
/**
*
...
*/
/** @test */
public function should_contains_all_infos()
{
// ----------- PART 1 -----------
...
$spathSQL = $oInit->GLOBALS_INI["PATH_HOME"] . $oInit->GLOBALS_INI["PATH_MODEL"] . "adm_info__getInfo.sql";
$aCompare = $oInit->oBdd->getSelectDatas($spathSQL, array(), false);



// ----------- PART 4 -----------
// Compare the 2 results with the assertion "assertCount" (Param 1 : number of results, Param 2 : array of results)
$this->assertCount($iNbInfo, $aCompare);
}
}
?>