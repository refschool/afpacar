...
require_once "adm_rating_service.php";

/**
 * Class "Adm_rating" / file "adm_rating.php"
 *
...
Class Adm_rating {
	 ...
	 * Constructor :
	 * 
	 * it is executed thanks to code "new Adm_rating()"
	...
	private function main() {
		...
		$this->oService= new Adm_rating_service();
