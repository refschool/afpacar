...
require_once "app_style_service.php";

/**
 * Class "App_style" / file "app_style.php"
 *
...
Class App_style {
	 ...
	 * Constructor :
	 * 
	 * it is executed thanks to code "new App_style()"
	...
	private function main() {
		...
		$this->oService= new App_style_service();
